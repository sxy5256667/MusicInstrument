...
public class KeyBoard extends Activity implements OnTouchListener{
	//状态变量
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //1-14号声音为白色琴键的声音
        soundMap.put(1, soundPool.load(this, R.raw.w1, 1)); 
        soundMap.put(2, soundPool.load(this, R.raw.w2, 1)); 
        soundMap.put(3, soundPool.load(this, R.raw.w3, 1)); 
        soundMap.put(4, soundPool.load(this, R.raw.w4, 1)); 
        soundMap.put(5, soundPool.load(this, R.raw.w5, 1)); 
        soundMap.put(6, soundPool.load(this, R.raw.w6, 1)); 
        soundMap.put(7, soundPool.load(this, R.raw.w7, 1)); 
        soundMap.put(8, soundPool.load(this, R.raw.w8, 1)); 
        soundMap.put(9, soundPool.load(this, R.raw.w9, 1)); 
        soundMap.put(10, soundPool.load(this, R.raw.w10, 1)); 
        soundMap.put(11, soundPool.load(this, R.raw.w11, 1)); 
        soundMap.put(12, soundPool.load(this, R.raw.w12, 1)); 
        soundMap.put(13, soundPool.load(this, R.raw.w13, 1)); 
        soundMap.put(14, soundPool.load(this, R.raw.w14, 1));         
        //15-24号声音为黑色琴键的声音
        soundMap.put(15, soundPool.load(this, R.raw.b1, 1)); 
        soundMap.put(16, soundPool.load(this, R.raw.b2, 1)); 
        soundMap.put(17, soundPool.load(this, R.raw.b3, 1)); 
        soundMap.put(18, soundPool.load(this, R.raw.b4, 1)); 
        soundMap.put(19, soundPool.load(this, R.raw.b5, 1)); 
        soundMap.put(20, soundPool.load(this, R.raw.b6, 1)); 
        soundMap.put(21, soundPool.load(this, R.raw.b7, 1));
        soundMap.put(22, soundPool.load(this, R.raw.b8, 1));
        soundMap.put(23, soundPool.load(this, R.raw.b9, 1)); 
        soundMap.put(24, soundPool.load(this, R.raw.b10, 1));
        //为变量绑定实体按钮
